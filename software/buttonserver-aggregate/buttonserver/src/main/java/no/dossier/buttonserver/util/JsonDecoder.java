...
import static no.dossier.buttonserver.util.List.cons;
import static no.dossier.buttonserver.util.List.nil;
import static no.dossier.buttonserver.util.Option.none;
import static no.dossier.buttonserver.util.Result.fail;
import static no.dossier.buttonserver.util.Result.failUnless;
import static no.dossier.buttonserver.util.Result.ok;
import static no.dossier.buttonserver.util.Result.okIf;

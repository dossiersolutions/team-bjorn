...
import no.dossier.thatbuttonserver.types.Action;
import no.dossier.thatbuttonserver.types.ButtonId;
import no.dossier.thatbuttonserver.types.ButtonState;
import no.dossier.thatbuttonserver.types.CmpOperator;
import no.dossier.thatbuttonserver.types.Condition;
...
import no.dossier.thatbuttonserver.types.PropertyType;
import no.dossier.thatbuttonserver.types.Settings;
import no.dossier.thatbuttonserver.types.Trigger;
import no.dossier.thatbuttonserver.util.JsonDecoder;
...
import static no.dossier.thatbuttonserver.types.Action.forwardMessageAction;
import static no.dossier.thatbuttonserver.types.Action.logEventAction;
import static no.dossier.thatbuttonserver.types.ButtonId.buttonIdResult;
import static no.dossier.thatbuttonserver.types.Condition.always;
import static no.dossier.thatbuttonserver.types.Condition.never;
import static no.dossier.thatbuttonserver.types.Condition.propertyBetweenOption;
import static no.dossier.thatbuttonserver.types.Condition.propertyComparison;
import static no.dossier.thatbuttonserver.types.Condition.propertyIn;
...
import static no.dossier.thatbuttonserver.util.JsonDecoder.fieldDecoder;
import static no.dossier.thatbuttonserver.util.JsonDecoder.flatMap2;
import static no.dossier.thatbuttonserver.util.JsonDecoder.integerDecoder;
import static no.dossier.thatbuttonserver.util.JsonDecoder.listDecoder;
import static no.dossier.thatbuttonserver.util.JsonDecoder.optionalFieldDecoder;
import static no.dossier.thatbuttonserver.util.JsonDecoder.stringDecoder;
import static no.dossier.thatbuttonserver.util.Result.optionResult;
